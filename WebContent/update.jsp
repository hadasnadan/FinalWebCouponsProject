      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="/FinalWebCouponsProject/controller/updatecoupon?logged=1">Update Coupon</a></li>
    ...
    <div class="container theme-showcase" role="main">
		...
		<form class="form-horizontal" method="post" action="update">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
				  <input type="text" name="description" class="form-control" placeholder="Coupon Description">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">Category</label>
				<div class="col-sm-10">
				  <input type="text" name="category" class="form-control" placeholder="Coupon Category">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">Longitude</label>
				<div class="col-sm-10">
				  <input type="text" name="longitude" class="form-control" placeholder="Coupon Longitude in Int">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">Latitude</label>
				<div class="col-sm-10">
				  <input type="text" name="latitude" class="form-control" placeholder="Coupon Latitude in Int">
				</div>
			</div>
			<div class="form-group">
				<label for="inputPassword3" class="col-sm-2 control-label">Expiration Date</label>
				<div class="col-sm-10">
				  <input type="text" name="date" class="form-control" placeholder="2015-01-27 09:29:19.0">
				</div>
			</div>
			  <div class="form-group">
